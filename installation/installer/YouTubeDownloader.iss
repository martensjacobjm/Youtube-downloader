...
Source: "..\scripts\YouTube_Downloader_GUI.ps1"; DestDir: "{app}\scripts"; Flags: ignoreversion
Source: "..\scripts\Download-Dependencies.ps1"; DestDir: "{app}\scripts"; Flags: ignoreversion
